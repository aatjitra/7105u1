/*
 * drivers/cpufreq/cpufreq_terrabuzzq.c
 *
 ...
 *
 * New Version: Ardi / aatjitra
 *
 * Driver values in /sys/devices/system/cpu/cpufreq/terrabuzzq
 *
 * This governor is derivation of lulzactiveq. It has the same hotplug mechanism
 * and it has more similar scaling up and down logic with a modification.
 * 
 */
...
#define TERRABUZZ_VERSION	(1)
#define TERRABUZZ_AUTHOR	"lulzactiveq by tegrak"

// if you changed some codes for optimization, just write your name here.
#define TERRABUZZ_TUNER "terrabuzzq by aatjitra"
...
static void cpufreq_lulzactive_timer(unsigned long data)
{
	...
	* But also if the frequency is mantained the freq_change_time
...
MODULE_DESCRIPTION("'terrabuzzQ' - improved lulzactiveq governor for scaling up and down");
MODULE_LICENSE("GPL");
