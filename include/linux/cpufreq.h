...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_TERRABUZZQ)
extern struct cpufreq_governor cpufreq_gov_terrabuzzq;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_terrabuzzq)
#endif
